...
export default function Footer() {
    ...
    useEffect(() => {
        (document.querySelector("#wrapper") as HTMLElement).style.marginBottom = `${(document.querySelector("#footer") as HTMLElement).offsetHeight + 10}px`;
    })
        ...
        <>
            <div className="p-3 w-screen fixed -z-10 left-0 right-0 bottom-0 text-black dark:text-white" id="footer">
                <div data-v-5b7f1ebd="" className="grow">
                    ...
                    <span data-v-5b7f1ebd="" className="mx-1">|</span>
                    <i data-v-5b7f1ebd="">
                        <a data-v-5b7f1ebd="" className=" opacity-75 hover:opacity-80 active:opacity-95" href="#">
                            <span data-v-5b7f1ebd="">蜀公网安备 -号</span>
                        </a>
                    </i><br />
                    <a data-v-5b7f1ebd="" className=" opacity-75 hover:opacity-80 active:opacity-95" href="https://www.12377.cn" target="_blank">
                        <i data-v-5b7f1ebd="" style={sty2}>违法和不良信息举报(中国)</i>
                    </a>
                </div>
            </div>
        </>
