                ...
                <div className="card-responsive grid gap-2 w-full! p-0!">
                    {cardData.map((card, index) => {
                        ...
                        if (enableStars) {
                            return (
                                <ParticleCard
                                    key={index}
                                    className={baseClassName + ' fade-in overflow-hidden! '}
                                    style={cardStyle}
                                    disableAnimations={shouldDisableAnimations}
                                ...
                                >
                                    ...
                                    <div className="card__content flex flex-col relative text-white">
                                        <h3 className={`card__title font-normal text-base text-shadow-lg text-shadow-zinc-200/30 m-0 -translate-y-1 pb-1  ${textAutoHide ? 'text-clamp-1' : ''}`}>
                                            {card.title}
                                        </h3>
                                        <p className={`card__description text-xs leading-5 text-shadow-lg text-shadow-zinc-200/30 opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`} >
                                            {card.description}
                                        </p>
                                    </div>
                                    <img src={card.bgImage} style={{ background: card.bgImage, ...card.bgStyle }}
                                        className='top-0 bottom-0 left-0 right-0 absolute -z-10' alt=""
                                    />
                                    {/* <div style={{ background: card.color, opacity: card.bgOpacity ?? 1 }} className='top-0 bottom-0 left-0 right-0 absolute -z-10 bg-center! bg-no-repeat!'></div> */}
                                </ParticleCard>
                            );
                        }
                    ...
                    `;
                            ...
                            >
                                ...
                                <div className="card__content flex flex-col relative text-white">
                                    <h3 className={`card__title font-normal text-base m-0 -translate-y-1  pb-1 ! ${textAutoHide ? 'text-clamp-1' : ''}`}>
                                        {card.title}
                                    </h3>
